 ...
 *******************************************************************************/
package com.shay.base.internal;
...
public abstract class LoadingLayout extends FrameLayout implements ILoadingLayout {
	...
	public LoadingLayout(Context context, final PullToRefreshBase.Mode mode,@PullToRefreshBase.Orientation final int direction,
		...
		if (attrs.hasValue(R.styleable.PullToRefreshBase_ptrHeaderBackground)) {
			Drawable background = attrs.getDrawable(R.styleable.PullToRefreshBase_ptrHeaderBackground);
			if (null != background) {
		...
		if (attrs.hasValue(R.styleable.PullToRefreshBase_ptrHeaderTextColor)) {
			ColorStateList colors = attrs
					.getColorStateList(R.styleable.PullToRefreshBase_ptrHeaderTextColor);
			if (null != colors) {
				setTextColor(colors);
			}
		}
		if (attrs.hasValue(R.styleable.PullToRefreshBase_ptrHeaderSubTextColor)) {
			ColorStateList colors = attrs
					.getColorStateList(R.styleable.PullToRefreshBase_ptrHeaderSubTextColor);
			if (null != colors) {
