...
public class PullToRefreshWebView extends PullToRefreshBase<WebView> {
	...
	public PullToRefreshWebView(Context context, @Modes  int modeType) {
	...
	public PullToRefreshWebView(Context context,@Modes  int modeType, @AnimationStyle int animaType) {
	...
	final class InternalWebViewSDK9 extends WebView {
		...
		private int getScrollRange() {
			return (int) Math.max(
					0, Math.floor(mRefreshableView.getContentHeight() * mRefreshableView.getScale()) - (getHeight() - getPaddingBottom() - getPaddingTop()));
		}
	}
}
